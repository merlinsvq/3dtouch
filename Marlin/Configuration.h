...
//#define NOZZLE_TO_PROBE_OFFSET { -10, -47, 5 }

//#define NOZZLE_TO_PROBE_OFFSET { -5, -47, 5 }
#define NOZZLE_TO_PROBE_OFFSET { 10, -47, -0.5 }
// de ender 3 #define NOZZLE_TO_PROBE_OFFSET { -39, -10, -0.1 }
 ...
 * For other boards you may need to define FIL_RUNOUT_PIN, FIL_RUNOUT2_PIN, etc.
 */
//FIL_RUNOUT es el nombre del pin

//#define FILAMENT_RUNOUT1_SENSOR
/*#if ENABLED(FILAMENT_RUNOUT1_SENSOR)
#define BUTTON1_PIN 28
  #define BUTTON1_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  #define NUM_RUNOUT1_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.

  #define BUTTON1_STATE     LOW        // Pin state indicating that filament is NOT present.
  //#define BUTTON1_PULLUP               // Use internal pullup for filament runout pins.
  #define BUTTON1_PULLDOWN           // Use internal pulldown for filament runout pins.
  //#define WATCH_ALL_RUNOUT_SENSORS      // Execute runout script on any triggering sensor, not only for the active extruder.
                                          // This is automatically enabled for MIXING_EXTRUDERs.
...
#define PREHEAT_BEFORE_LEVELING
  ...
  #define LEVELING_BED_TEMP     40//50
#endif
...
#define LCD_BED_TRAMMING
 ...
 #define BED_TRAMMING_INSET_LFRB { 30, 45, 45, 55 } // (mm) Left, Front, Right, Back insets
