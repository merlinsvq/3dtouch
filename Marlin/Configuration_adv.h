...
//#define EXTRUDER_RUNOUT_PREVENT
  ...
  #define EXTRUDER_RUNOUT_MINTEMP 240//190
 ...
 */
#define BABYSTEPPING    //descomentado
...
//#define CUSTOM_MENU_CONFIG
  ...
  //#define CUSTOM_MENU_CONFIG_TITLE "Custom Commands" "Toold Hedas"  //aqui se definido en que nivel de los menus estara
...
#define CUSTOM_USER_Botones
/*
#if ENABLED(CUSTOM_USER_Botones)
  //#define CUSTOM_GREENBTN_PIN 28
  //#define CUSTOM_GREENBTN_PIN -1
  #if PIN_EXISTS(CUSTOM_GREENBTN_PIN)
    queue.inject(F("G28")); 
  #else
    queue.inject(F("G1 X15 F1000")); 
      #endif
#endif  
*/
...
//M42  - Change pin M42status via G-code: M42 P<pin> S<value>. LED pin assumed if P is omitted. (Requires DIRECT_PIN_CONTROL)
// esta MarlinCore.cpp linea 512 y 1424
